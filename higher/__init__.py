...
def innerloop_ctx(
    ...
    Args:
        ...
        accumulation_steps: the number of steps to accumulate gradients over
            before performing a parameter update. This is useful for simulating
            larger batch sizes than can fit on a single GPU, and can be used in
            conjunction with gradient clipping to stabilize training.
